...
var tokens = {
  ...
  SD: {
    ...
    website: 'https://staderlabs.com/',
    description:
      'Stader (SD) token is the native governance and value accrual token for Stader.',
  },
  CONE: {
    name: 'Cone token',
    symbol: 'CONE',
  ...
  PEX: {
    ...
    description:
      'Trade, earn and meet people in the new decentralized marketplace.',
  },
  FROYO: {
    name: 'Froyo',
    symbol: 'FROYO',
    ...
    description:
      'Be part of the future of gaming with play to earn games, NFTs & digital assets.',
  },
  VALAS: {
    name: 'Valas Finance',
    symbol: 'VALAS',
  ...
  SING: {
    ...
    logoURI:
      'https://github.com/singularfarm/assets/blob/main/400.png?raw=true',
  },
  ONG: {
  ...
  PACOCA: {
    ...
    description:
      'Invest in yield-optimizing vaults and track your DeFi assets on BSC',
  ...
  LONG: {
    ...
    decimals: 18,
    logoURI:
      'https://longdrink.finance/static/media/longdrink-logo.0b6c21de.png',
    description:
  ...
  PEAR: {
    ...
    chainId: 56,
    logoURI:
      'https://assets.coingecko.com/coins/images/17173/small/pear200.png',
    description:
  ...
  USDO: {
    ...
    decimals: 18,
    logoURI:
      'https://assets.coingecko.com/coins/images/14828/small/New_USDO_32px_.png',
  ...
  POTS: {
    ...
    description:
      'The win-win lottery on BSC where every ticket earns you interest.',
    logoURI:
  ...
  BMON: {
    ...
    description:
      'A complete metaverse of digital monsters inspired by Axie Infinity',
  },
  WSG: {
  ...
  DEP: {
    ...
    logoURI:
      'https://pbs.twimg.com/profile_images/1258627009296531456/qGAevdn7_400x400.png',
  },
  SISTA: {
  ...
  JulD: {
    ...
    description:
      'JulSwap offers automated, decentralized exchange of BSC-20 tokens.',
    logoURI:
      'https://tokens.julswap.com/images/0x5A41F637C3f7553dBa6dDC2D3cA92641096577ea.png',
  },
  SOUP: {
    name: 'Soup',
    symbol: 'SOUP',
  ...
  SALT: {
    ...
    description:
      'SALT is the native token of Saltswap.finance yield aggregator.',
  ...
  BREW: {
    ...
    description:
      'REW is native Binance Smart Chain token on the cafeswap.finance platform.',
  ...
  SOAK: {
    ...
    description:
      'The Soak token is the main token that will be emitted by Sponge.finance.',
  ...
  FINE: {
    ...
    description:
      'Refinable is the first dedicated NFT marketplace built on Binance Smart Chain.',
  ...
  GOAL: {
    ...
    description:
      'GOAL is the native token of the fanaticsfinance.com yield aggregator.',
    logoURI: '',
  },
  SPACE: {
    ...
    description:
      'SPACE is the native token of the farm.space yield aggregator.',
    logoURI: '',
  },
  WIN: {
    name: 'WINk Token',
  ...
  xBLZD: {
    ...
    description:
      'xBLZD is the native token of Blizzard.money where users can yield their tokens.',
  ...
  DICE: {
    ...
    description:
      'DICE.FINANCE is a fully decentralized protocol for a casino on Ethereum.',
    logoURI:
  ...
  lUSD: {
    ...
    description:
      'LUSD is the USD-pegged stablecoin used to pay out loans on the Liquity protocol.',
    logoURI:
  ...
  BRY: {
    ...
    description:
      'Berry is a decentralized oracle network on the Binance Smart Chain.',
    logoURI:
  ...
  pBTC: {
    ...
    description:
      'pBTC is a 1:1 pegged ERC777 Bitcoin representation on Ethereum.',
    logoURI:
  ...
  EPS: {
    ...
    description:
      'Ellipsis protocol enables extremely efficient stable coin exchanges.',
    logoURI:
  ...
  dBTC: {
    ...
    description:
      'dBTC is a synthetic token pegged to BTC developed by Diamonhand.fi.',
  ...
  dBNB: {
    ...
    website: 'https://diamondhand.fi/',
    description:
      'dBNB is a synthetic token pegged to BNB developed by Diamonhand.fi.',
  ...
  dETH: {
    ...
    website: 'https://diamondhand.fi/',
    description:
      'dETH is a synthetic token pegged to ETH developed by Diamonhand.fi.',
  ...
  dADA: {
    ...
    website: 'https://diamondhand.fi/',
    description:
      'dADA is a synthetic token pegged to ADA developed by Diamonhand.fi.',
  ...
  dDOT: {
    ...
    website: 'https://diamondhand.fi/',
    description:
      'dDOT is a synthetic token pegged to DOT developed by Diamonhand.fi.',
    logoURI: '',
  },
  KROWN: {
    name: 'Krown',
  ...
  CARROT: {
    ...
    decimals: 18,
    logoURI:
      'https://mdex.co/token-icons/bsc/0xa5043373edc09f3f7d87fe35ca933e0a7b59d005.png',
    description:
  ...
  HERO: {
    ...
    description:
      'FarmHero.io is a novel protocol that mixes NFT, gaming and DEFI concepts.',
  ...
  LAC: {
    ...
    description:
      'LaCucina will offer you new and exciting ways to succeed in DeFi with NFTs',
  },
  SAND: {
    name: 'The Sandbox',
    symbol: 'SAND',
