var CRO = {
  ...
  logoURI:
    'https://vvs.finance/images/tokens/0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23.svg',
};
var tokens = {
  CRO: CRO,
  WCRO: CRO,
  ...
  FIRA: {
    ...
    decimals: 18,
    logoURI:
      'https://vvs.finance/images/tokens/0x7ABa852082b6F763E13010CA33B5D9Ea4EeE2983.svg',
  ...
  VERSA: {
    ...
    decimals: 18,
    logoURI:
      'https://vvs.finance/images/tokens/0x00D7699b71290094CcB1a5884cD835bD65a78c17.svg',
  ...
  MTD: {
    ...
    logoURI:
      'https://vvs.finance/images/tokens/0x0224010BA2d567ffa014222eD960D1fa43B8C8E1.svg',
  },
  FER: {
    name: 'Ferro',
    symbol: 'FER',
    ...
    logoURI:
      'https://vvs.finance/images/tokens/0x39bC1e38c842C60775Ce37566D03B41A7A66C782.svg',
  },
  sCRO: {
    name: 'sCRO',
    symbol: 'sCRO',
  ...
  ALI: {
    ...
    decimals: 18,
    logoURI:
      'https://vvs.finance/images/tokens/0x45C135C1CDCE8d25A3B729A28659561385C52671.svg',
  ...
  SKY: {
    ...
    description:
      'The first algorithmic token pegged to CRO running on the Cronos Chain',
    logoURI:
      'https://assets.coingecko.com/coins/images/22517/small/logo-token-2.e9c15b63.png',
  },
  DARK: {
    chainId: 25,
    ...
    description:
      'The first algorithmic token pegged to CRO running on the Cronos Chain',
    logoURI:
      'https://assets.coingecko.com/coins/images/22456/small/DARK_bgWhite.png',
  },
  BIFI: {
    chainId: 25,
  ...
  TONIC: {
    ...
    logoURI:
      'https://vvs.finance/images/tokens/0xDD73dEa10ABC2Bff99c60882EC5b2B81Bb1Dc5B2.svg',
  },
  LIQ: {
    name: 'Liquidus',
    symbol: 'LIQ',
    ...
    logoURI:
      'https://farm.liquidus.finance/static/media/liquidus_logo_round.f72f345a.png',
  },
  ATOM: {
    name: 'Cosmos Token',
    symbol: 'ATOM',
  ...
  VVS: {
    ...
    decimals: 18,
    logoURI:
      'https://vvs.finance/images/tokens/0x2D03bECE6747ADC00E1a131BBA1469C15fD11e03.svg',
