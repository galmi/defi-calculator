...
var tokens = {
  ...
  FUSD: {
    ...
    decimals: 18,
    logoURI:
      'https://assets.coingecko.com/coins/images/22230/large/fUSD_32.png?1641246519',
    website: 'https://fantom.foundation/defi/',
    description:
      'Mint fUSD, the stablecoin on Fantom pegged 1:1 to the USD price, using your FTM.',
  },
  MIDAS: {
    name: 'MIDAS',
    symbol: 'MIDAS',
  ...
  SHRAP: {
    ...
    description:
      'Shrapnel is an inflationary token launched along with BombSwap.',
  },
  BSHARE: {
    name: 'BSHARE',
    symbol: 'BSHARE',
  ...
  BASED: {
    ...
    description:
      'Based Finance the first algorithmic token pegged to TOMB on the FTM Network.',
    logoURI:
      'https://assets.coingecko.com/coins/images/23535/small/BASED_TOKEN.109291b9.png',
  },
  ATLAS: {
    name: 'Atlas Cloud',
    symbol: 'ATLAS',
  ...
  WIGO: {
    ...
    logoURI:
      'https://wigoswap.io/images/tokens/0xE992bEAb6659BFF447893641A378FbbF031C5bD6.svg',
  },
  PAE: {
    name: 'Ripae',
    symbol: 'PAE',
  ...
  xBOO: {
    ...
    logoURI:
      'https://assets.coingecko.com/coins/images/22609/large/xboo.png?1642220445',
  },
  MULTI: {
    name: 'Multichain',
    symbol: 'MULTI',
  ...
  SUMMIT: {
    ...
    chainId: 250,
    logoURI:
      'https://assets.coingecko.com/coins/images/19389/small/CE2Sdy2.png',
  ...
  TAROT: {
    ...
    logoURI:
      'https://assets.coingecko.com/coins/images/17881/large/tarot-200px.png?1629704943',
  },
  MAI: {
    name: 'Mai',
    symbol: 'miMATIC',
  ...
  GEIST: {
    ...
    decimals: 18,
    logoURI:
      'https://assets.coingecko.com/coins/images/18832/small/GEIST-token.png?1633560935',
  ...
  FOO: {
    ...
    description:
      'Fantums are Opera themed digital collectibles (NFTs) on the Fantom blockchain.',
  },
  ZOO: {
    name: 'ZooCoin',
  ...
  SHADE: {
    ...
    description:
      'A decentralized protocol for private transactions on Fantom Opera',
